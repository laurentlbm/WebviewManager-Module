...
ui_print " "
# sleep 0.15
ui_print ">>> Webview Manager Lite | By Androidacy & LL <<<"
# sleep 0.15
ui_print " "
# sleep 0.15
...
# am start -a android.intent.action.VIEW -d "https://www.androidacy.com/install-done/?f=wvm_module&r=wmi&v=10.1.2" &>/dev/null
# sleep 0.15
ui_print " "
